...
public:
    ...
    void rcvOdometryCallback(const nav_msgs::Odometry & odom)
    {
        ...
        _vis_cmd.header.frame_id = "world_enu"; //改
        ...
        if(state == INIT )
        {
            ...
            _cmd.header.frame_id = "world_enu"; //改
    ...
    void pubPositionCommand()
    {
        ...
        if (state == HOVER)
        {
            if (_cmd.header.frame_id != "world_enu"){ //改
                _cmd.position = _odom.pose.pose.position;
            }
        ...
        _vis_vel.ns = "vel";
        _vis_vel.id = 0;
        _vis_vel.header.frame_id = "world_enu"; //改
        ...
        _vis_acc.ns = "acc";
        _vis_acc.id = 0;
        _vis_acc.header.frame_id = "world_enu"; //改
